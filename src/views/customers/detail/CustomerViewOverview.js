...
import CustomerInvoiceListTable from 'src/views/customers/detail/CustomerInvoiceListTable';
import CustomerProjectListTable from 'src/views/customers/detail/CustomerProjectListTable';
...
const CustomerViewOverview = () => {
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <CustomerProjectListTable />
      </Grid>
      <Grid item xs={12}>
        <CustomerProjectListTable />
      </Grid>
...
export default CustomerViewOverview;
