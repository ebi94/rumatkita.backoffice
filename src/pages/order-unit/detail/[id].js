...
import { detailOrderUnit } from 'src/services/orderUnit';
    ...
    <>
      <Grid container spacing={6} className="match-height">
        ...
        <Grid item md={6} sm={6} xs={12}>
          <Card>
            <CardHeaderStyled title="Detail Order Unit" />
          ...
          <Card>
            ...
            <CardContent>
              ...
              <Grid container sx={{ mb: 2 }}>
                ...
                <Grid item md={9}>
                  <Typography variant="body2">{dataDetail?.clinic?.complete_address}</Typography>
                </Grid>
              </Grid>
              <Grid container sx={{ mb: 2 }}>
                <Grid item md={3} sx={gridTitle}>
